...
public class Messages_fr_CA extends ListResourceBundle {
    ...
    static final Object[][] contents = {
        ...
        {"message.autre", "Autre"},
        {"message.sex", "Sex"},
        {"message.masculin", "Masculin"},
        {"message.feminin", "Feminin"},
        {"message.a", "à"},
        {"message.age", "Age"},
        {"message.photo", "Photo"},
        {"message.image", "Image"},
        ...
        {"message.catalogueVide", "Le catalogue est vide"},
