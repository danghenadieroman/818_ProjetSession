...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet ConnectUtilisateur</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet ConnectUtilisateur at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(users.checkPassword(login, pwd)){
            //
        } else {
            response.setContentType("text/html;charset=UTF-8");
            try (PrintWriter out = response.getWriter()) {
